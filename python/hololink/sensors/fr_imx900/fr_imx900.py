...
class Imx900Cam:
    ...
    def configure_converter(self, converter):
        ...
        if self._mode.value == imx900_mode.imx900_Mode.imx900_mode_2048x1552_12BPP.value:
            ...
            metadata_size = 3072  # line metadata bytes
            ...
            metadata_size = 2560  # line metadata bytes
            ...
            metadata_size = 2048  # line metadata bytes
        ...
        # Skip margin_top lines (40 lines of optical black)
        margin_top = 40
